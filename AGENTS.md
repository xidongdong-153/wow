...
- **公共情报三大模块全职业全天赋覆盖规范（强制遵守）**：
  - `news/`（每日情报）：必须贯彻全职业生态雷达定位。大秘境高层突破必须拆解 5 人全队配置与战术协同（覆盖战、萨、法、贼、德、僧、猎、术、牧、龙、骑、DK、DH 全职业）；每日追踪全职业天梯异动、黑马专精与冷门英雄天赋突破；严禁仅关注死亡骑士与圣骑士。
  - `patches/`（补丁与热修）：必须贯彻全职业全专精量化评估。改动条目必须完整收录官方公告中所有受影响职业、通用技能与英雄天赋树；四维量化评估必须覆盖坦克、治疗、近战输出、远程输出四大职责；严禁仅选择性摘录单一或两个职业。
  - `rankings/`（强度排行榜）：天梯榜单与归因分析必须基于全职业 39+ 专精的大数据中立生成。核心梯队归因与深度剖析必须覆盖四大职责的整体生态演变、主流流派更替与黑马专精异动，杜绝将榜单总结异化为单一职业宣传。
