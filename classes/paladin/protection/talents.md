...
| 英雄天赋 | 大秘境使用率 | 大秘境均伤 (DPS) | 团本史诗使用率 | 团本史诗承伤评分 | 特点定位 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **铸光者 (Lightsmith)** | **79.4%** (绝对核心) | **154.3k** | **75.1%** | 极高团队协同与吸收护盾 | 圣圣武装与神圣武器为自身与队友提供持续巨额吸收盾与伤害反哺 |
| **圣殿骑士 (Templar)** | 20.5% | 130.8k | 24.9% | 单体直伤与单体硬度 | 灰烬觉醒后打出圣殿天锤，侧重单体输出与短轴爆发伤害 |
