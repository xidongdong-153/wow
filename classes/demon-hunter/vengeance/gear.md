---
title: 复仇恶魔猎手配装指南
description: Chaosfiend's Shroud (混魔的寿衣)穿戴率、武器排行、双美化与单体及双 BiS 饰品组合速查
...
## 1. 套装选择（Chaosfiend's Shroud (混魔的寿衣)）

4件套：邪能尖刺护甲加成提高 30%，施放烈火烙印使周围所有目标陷入脆弱并为你提供 20% 吸血。

| 部位 | 装备名称 | 属性 | 大秘境使用率 | 说明 |
| :--- | :--- | :--- | :--- | :--- |
| **头部 (Head)** | Chaosfiend's Crown | 暴击 / 急速 | **82.4%** | 极品完美属性，必带 |
| **胸甲 (Chest)** | Chaosfiend's Vestment | 急速 / 精通 | **79.5%** | 极品属性，必带 |
| **手套 (Hands)** | Chaosfiend's Gloves | 暴击 / 精通 | **73.1%** | 极品属性，必带 |
| **腿部 (Legs)** | Chaosfiend's Breeches | 精通 / 暴击 | **68.4%** | 极品属性，优先搭配 |
| **肩部 (Shoulders)**| Chaosfiend's Epaulets | 全能 / 精通 | 35.2% | 通常作为散件替换部位 |
...
- **制造极品武器**：双持血骑士敏捷复仇战刃 (急速全能)，公文锁定核心副属性，性价比极高。
