---
title: 踏风武僧配装指南
description: Serene Master's Gi (安详大师的武僧服)穿戴率、武器排行、双美化与单体及双 BiS 饰品组合速查
...
## 1. 套装选择（Serene Master's Gi (安详大师的武僧服)）

4件套：怒雷破伤害提高 20%，风火雷电期间每次施放神鹤引颈踢必定召唤白虎雪怒劈下雷霆。

| 部位 | 装备名称 | 属性 | 大秘境使用率 | 说明 |
| :--- | :--- | :--- | :--- | :--- |
| **头部 (Head)** | Serene Crown | 暴击 / 急速 | **82.4%** | 极品完美属性，必带 |
| **胸甲 (Chest)** | Serene Vestment | 急速 / 精通 | **79.5%** | 极品属性，必带 |
| **手套 (Hands)** | Serene Gloves | 暴击 / 精通 | **73.1%** | 极品属性，必带 |
| **腿部 (Legs)** | Serene Breeches | 精通 / 暴击 | **68.4%** | 极品属性，优先搭配 |
| **肩部 (Shoulders)**| Serene Epaulets | 全能 / 精通 | 35.2% | 通常作为散件替换部位 |
...
- **制造极品武器**：双持血骑士拳套/单手剑 (全能暴击)，公文锁定核心副属性，性价比极高。
