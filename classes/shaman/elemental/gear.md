---
title: 元素萨满祭司配装指南
description: Elemental Ascendant's Harness (元素升腾者的铠甲)穿戴率、武器排行、双美化与单体及双 BiS 饰品组合速查
...
## 1. 套装选择（Elemental Ascendant's Harness (元素升腾者的铠甲)）

4件套：大地震击与地震术伤害提高 20%，先知唤醒的先祖持续时间延长 5 秒且复制熔岩爆发。

| 部位 | 装备名称 | 属性 | 大秘境使用率 | 说明 |
| :--- | :--- | :--- | :--- | :--- |
| **头部 (Head)** | Elemental Crown | 暴击 / 急速 | **82.4%** | 极品完美属性，必带 |
| **胸甲 (Chest)** | Elemental Vestment | 急速 / 精通 | **79.5%** | 极品属性，必带 |
| **手套 (Hands)** | Elemental Gloves | 暴击 / 精通 | **73.1%** | 极品属性，必带 |
| **腿部 (Legs)** | Elemental Breeches | 精通 / 暴击 | **68.4%** | 极品属性，优先搭配 |
| **肩部 (Shoulders)**| Elemental Epaulets | 全能 / 精通 | 35.2% | 通常作为散件替换部位 |
...
- **制造极品武器**：制造血骑士元素法杖 (精通急速)，公文锁定核心副属性，性价比极高。
- **团本史诗武器**：团本 5 号盾牌魔杖，装等上限最高。
