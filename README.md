...
- 精细热修版本：**12.1.0.61234-hotfix.0915.1**（暴雪论坛 Post ID: `1954890`，Rev 1）
- 生效热修文档：`patches/12.1/2026-09-15-tuning.md`
- 数据同步状态：已同步（对齐 2026-09-15 在线修正）
- 建议归档标签：`v12.1.0.61234-hotfix.20260915.1`
- 版本规范说明：`VERSION.md`
