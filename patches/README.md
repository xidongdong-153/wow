...
当前生效热修：**12.1.0.61234-hotfix.0915.1**（暴雪论坛 Post ID: `1954890`，Rev 1）
官方蓝贴地址：[暴雪官方美服论坛在线修正帖 #1954890](https://us.forums.blizzard.com/en/wow/t/hotfixes-september-15-2026/1954890) | [Wowhead 热修归档镜像](https://www.wowhead.com/news=346580)
...
每篇补丁或热修分析文档必须涵盖完整的四维量化评估，覆盖坦克、治疗、近战与远程四大职责，严禁仅针对单一或少数职业：

1. **官方改动条目全量提取原则（强制遵守）**
   - 必须完整提取暴雪公告中所有被调整职业的技能、专精与英雄天赋，严禁漏项。
...
3. **四大职责实战生态位移矩阵**
   - **坦克职责（Tank）**：防战、防骑、血DK、熊德、酒仙、复仇DH的硬免伤覆盖率、尖刺物理/法术承伤、自愈吞吐量与战术聚怪能力变化。
   - **治疗职责（Healer）**：奶骑、奶萨、神牧、戒律、奶僧、奶德、恩护龙的瞬时爆发抬血（HPS）、持续平稳预铺、蓝耗经济性与全队减伤光环变动。
   - **近战输出（Melee DPS）**：武器/狂怒战、惩戒骑、冰/邪DK、奇袭/狂徒/敏锐贼、踏风僧、浩劫/噬灭DH、生存猎、增强萨、野德的单体纯木桩吞吐量、短 CD 波次爆发峰值、斩杀期处决伤害与近战走位生存环境。
   - **远程输出（Ranged DPS）**：元素萨、奥/火/冰法、痛苦/恶魔/毁灭术、暗牧、鸟德、兽王/射击猎、湮灭/增辉龙的站桩读条惩罚、多目标长线跳伤、转火灵活性与团队增益。
4. **配装、天赋与手法全职业应对动作**
   - **配装与饰品**：BiS 饰品组合是否变更、制造装双美化优先级调整、四件套部件替换。
   - **天赋重构**：英雄天赋树分流（如武器战灭战者 vs 巨神兵、奥法日怒 vs 缚咒者、DK天启 vs 萨莱茵、惩戒骑烈日 vs 锻光）、核心天赋点取舍。
...
- **2026-09-15 在线热修与副本机制调整深度分析**
  - 文件路径：`patches/12.1/2026-09-15-tuning.md`
  - 关联版本：`12.1.0.61234-hotfix.0915.1`（Post ID: `1954890`，Rev 1）
  - 官方蓝贴直达：
  ...
  - 核心改动摘要：
    - **地下城机制**：毒牙祭坛三号首领剧毒仪式引导免疫打断判定修复，剧毒潜伏者流血伤害降低 8%；红玉新生法池二号首领烈焰暴怒者火球伤害判定盒对齐，环境 AOE 降低 5%；诸王之眠一号首领吐金脱战宠物锁定修复。
    - **团队副本**：烈毒之渊尾王乌拉特克 P3 阶段虚空剧毒爆发远距离全额穿透击杀修复，史诗召唤物生命值降低 3%。
    - **职业修复**：萨莱茵超目标大怪判定时间戳校准；双持冰霜副手伤害加成同步生效；防护圣骑士神圣之盾吸收盾与饰品覆盖冲突修复。
